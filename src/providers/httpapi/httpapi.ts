...
import { sysOptions } from '../system.constants';
...
export class HttpService {
  public headers: any;
  public content: string = 'Please Wait ..';
  ...
  private postCallWithLoader(completeURL,postData){
    return new Promise((resolve, reject) => {
      ...
      if(sysOptions.systemLanguage == 'ar')
        this.content = '..الرجاء الإنتظار'
